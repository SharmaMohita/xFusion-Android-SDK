package com.teramatrix.xfusionlibrary.controller;
...
public class RESTClient {
    ...
    public static final String CREATE_DEVICE = "/XFusionPlatform/device/add/device";
    public static final String LOCATION_API_Country_LIST = "/XFusionPlatform/country/get/country";
    public static final String LOCATION_API_STATE_LIST = "/XFusionPlatform/state/get/state";
    public static final String LOCATION_API_CITY_LIST = "/XFusionPlatform/city/get/city";
    public static final String ORGANIZATION_LIST = "/XFusionPlatform/organization/get/all";
    ...
    public static Call getCountryLocationList(Context context, String body, Callback callback) {
        Request request = new Request.Builder().url(new SdkSPUtils(context).get_API_End_Point() + LOCATION_API_Country_LIST)
                .post(RequestBody.create(mediaType, body)).build();
        Call call = client.newCall(request);
        call.enqueue(callback);
        printRequest(request, true);
    ...
    /*Get List of All State asscociated with a Country ID*/
    public static Call getStateLocationList(Context context, String body, Callback callback) {
        Request request = new Request.Builder().url(new SdkSPUtils(context).get_API_End_Point() + LOCATION_API_STATE_LIST)
                .post(RequestBody.create(mediaType, body)).build();
        Call call = client.newCall(request);
        call.enqueue(callback);
        printRequest(request, true);
    ...
    /*Get List of All City asscociated with a STATE ID*/
    public static Call getCityLocationList(Context context, String body, Callback callback) {
        Request request = new Request.Builder().url(new SdkSPUtils(context).get_API_End_Point() + LOCATION_API_CITY_LIST)
                .post(RequestBody.create(mediaType, body)).build();
        Call call = client.newCall(request);
        call.enqueue(callback);
        printRequest(request, true);
    ...
    public static Call getOrganizationList(Context context, String body, Callback callback) {
        Request request = new Request.Builder().url(new SdkSPUtils(context).get_API_End_Point() + ORGANIZATION_LIST)
                .post(RequestBody.create(mediaType, body)).build();
        Call call = client.newCall(request);
        call.enqueue(callback);
        printRequest(request, true);
    ...
    /*Create devcie on platform*/
    public static Call createDevice(Context context, String body, Callback callback) {
        Request request = new Request.Builder().url(new SdkSPUtils(context).get_API_End_Point() + CREATE_DEVICE)
                .post(RequestBody.create(mediaType, body)).build();
        Call call = client.newCall(request);
        call.enqueue(callback);
        printRequest(request, true);
