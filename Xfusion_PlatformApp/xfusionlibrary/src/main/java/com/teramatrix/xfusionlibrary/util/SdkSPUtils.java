...
public class SdkSPUtils {
    ...
    public static final String DEVCIE_DATA_API_UPDATE_INTERVAL = "servcie_data_api_update_interval";

    public static final String LOCATION_LATITUDE = "location_latitude";
    public static final String LOCATION_LONGITUDE = "location_longitude";
    public static final String LOCATION_ACCURACY = "location_accuracy";
    public static final String LOCATION_PROVIDER = "location_provider";
    public static final String LOCATION_LOG_TIME = "location_log_time";
